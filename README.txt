...
QUICK START
-----------
  export NOEMAP_BASE=~/unix-toolkit-tools/noemap   # or add to ~/.profile
...
-----------
  ...
  CLIPSO_BIN     Path to clipso binary (default: ~/unix-toolkit-tools/clipso/clipso.sh)
